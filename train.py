...
MODEL_NAME = "unsloth/Qwen2.5-VL-2B-Instruct"
PROMPT = "Translate this American Sign Language video into English text."
MAX_SEQ_LENGTH = 2048


def _record_to_sample(record: dict) -> dict:
    """Convert a manifest record to ChatML with PIL Images embedded in content."""
    images = [{"type": "image", "image": PILImage.open(fp).convert("RGB")} for fp in record["frame_paths"]]
